...
<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <form method="POST" action="{{ $isEditing ? route('purchases.detailed.update', $purchase) : route('purchases.detailed.store') }}" class="space-y-6 rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
                @csrf
                @if($isEditing)
                    @method('PATCH')
                @endif
                ...
                <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div>
                        ...
                        <input name="invoice_number" type="text" value="{{ old('invoice_number', $purchase?->invoice_number) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                ...
                                @foreach ($oldItems as $index => $item)
                                    <tr class="align-top">
                                        ...
                                        <td class="px-3 py-2">
                                            ...
                                            @error("items.$index.manual_total_cost")
                                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                            @enderror
                                        </td>
                ...
                <div class="grid gap-4 rounded-lg bg-gray-50 p-4 md:grid-cols-6 text-sm">
                    <div>
                        <p class="text-gray-500">Líneas</p>
                        <p id="summary-lines" class="mt-1 text-lg font-semibold text-gray-900">0</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Subtotal</p>
                        <p id="summary-subtotal" class="mt-1 text-lg font-semibold text-gray-900">$0.00</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Impuestos líneas</p>
                        <p id="summary-line-taxes" class="mt-1 text-lg font-semibold text-gray-900">$0.00</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Globales</p>
                        <p id="summary-globals" class="mt-1 text-lg font-semibold text-gray-900">$0.00</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Unidades recibidas</p>
                        <p id="summary-quantity" class="mt-1 text-lg font-semibold text-gray-900">0.000</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Total estimado</p>
                        <p id="summary-total" class="mt-1 text-lg font-semibold text-gray-900">$0.00</p>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            addButton.addEventListener('click', () => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-3 py-2">
                        <div class="space-y-1 text-xs text-gray-600">
                            <label class="flex items-center gap-1"><input type="checkbox" name="items[${index}][eligible_for_global_iva]" value="1" class="line-input"> IVA</label>
                            <label class="flex items-center gap-1"><input type="checkbox" name="items[${index}][eligible_for_global_ice]" value="1" class="line-input"> ICE</label>
                            <label class="flex items-center gap-1"><input type="checkbox" name="items[${index}][eligible_for_global_other]" value="1" class="line-input"> Otro</label>
                        </div>
                    </td>
            ...
            document.querySelectorAll('.global-summary-input').forEach((input) => {
                input.addEventListener('input', refreshSummary);
            });
